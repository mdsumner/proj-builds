...
## copied from rocker versioned2 2023-12-22
## wget https://raw.githubusercontent.com/rocker-org/rocker-versioned2/master/scripts/setup_R.sh
...
if [ ! -x "$(command -v r)" ]; then
    ...
    Rscript -e "install.packages(c('littler', 'docopt', 'rlang', 'lifecycle'), repos='${CRAN_SOURCE}')"
